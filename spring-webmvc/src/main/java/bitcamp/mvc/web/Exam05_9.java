...
public class Exam05_9 {
    ...
    public String m4(
        ...
        return String.format("m3():name=%s, age=%f, tel=%s", map.get("name"), map.get("age"), map.get("tel"));
    }
    ...
    public String m5(
        ...
        return String.format("m3():no=%d, title=%s, content=%s, createdDate=%s", 
                board.getNo(), 
                board.getTitle(), 
                board.getContent(), 
