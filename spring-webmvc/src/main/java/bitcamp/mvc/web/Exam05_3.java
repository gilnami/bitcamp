...
public class Exam05_3 {
    ...
    // 테스트:
    // http://localhost:8888/spring-webmvc/mvc/exam05_3/m1?no=11&title=aaaa&content=bbbb
    @GetMapping(value="m1")
    @ResponseBody
    ...
    // 테스트:
    // http://localhost:8888/spring-webmvc/mvc/exam05_3/m2?no=11&title=aaaa&content=bbbb&writer=honggildong
    @GetMapping(value="m2")
    @ResponseBody
    ...
    // 객체 안에 있는 프로퍼티 값 설정하기
    // 테스트:
    // http://localhost:8888/spring-webmvc/mvc/exam05_3/m3?no=11&title=aaaa&content=bbbb&user.id=hong&user.email=hong@test.com&user.password=1111
    @GetMapping(value="m3")
    @ResponseBody
